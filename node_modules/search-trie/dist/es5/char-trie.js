...
exports.buildCharacterTrie = void 0;
...
var put = function (node, str, value, edgeNodes, values, edgeDelimiter) {
    ...
    for (var _i = 0, str_1 = str; _i < str_1.length; _i++) {
        ...
        nextNode = node[c];
        if (!nextNode) {
            nextNode = node[c] = Object.create(magic_1.EMPTY);
            if (c === edgeDelimiter) {
 ...
 */
var buildCharacterTrie = function (words, edgeDelimiter) {
    if (edgeDelimiter === void 0) { edgeDelimiter = '.'; }
    var root = Object.create(magic_1.EMPTY);
...
exports.buildCharacterTrie = buildCharacterTrie;
